...
function submitForm(obj ) {
	...
	if (l.value == "Search" )
	{
	   ...
	   document.f.action = "/cgi-bin/index25.pl";
	   document.f.submit();
	   return true;
	 }
...
/* being basic styles */
	...
	.checkbox {font-family: arial, helvetica, sans-serif; font-size: 9pt; color: #0000FF}
...
/* other font types */
	...
	.bwsmaller {font-family: arial, helvetica, sans-serif; font-size: 11px; color: T_COLOR_FONT}
        ...
        .categorymain {font-family: arial, helvetica, sans-serif; font-size: 10pt; color: #0000FF; font-weight: bold}
	    .categorysub {font-family: arial, helvetica, sans-serif; font-size: 9pt; color: #0000FF}
		.categorysubbold {font-family: arial, helvetica, sans-serif; font-size: 9pt; color: #0000FF; font-weight: bold}
/* other td types */
...
<table align="center">
 ...
 <tr>
            <td><input type=submit value="Home" name="home">
			<input type=submit value="Advanced Search" name="as" onClick="location.href='/adv_search.html';return false;"> 
    ...
    <table cellpadding="0" cellspacing="0" width="85%" align="center">
        <tr> 
		  ...
		  <table align="center" width="85%" border="1" bgcolor="#FFFF66" cellpadding="1" cellspacing="0"><tr><td>
		  <table border="0" bgcolor="#FFFF66" cellpadding="1" cellspacing="0" width="94%" align="center">
                <tr>
                ...
                <tr> 
                 ...
                 <tr><td><font class="bluetext">Show</font>&nbsp;&nbsp;
                   ...
                   <td><font class="bluetext">Select</font>&nbsp;&nbsp;
			           ...
			           <option value="large">Large Firms</option>
			           <option value="medium">Medium Firms</option>
			           <option value="small">Small Firms</option>
                     </select></td>
                  </tr>
				  <tr><td><img src="images\spacer.gif" width = "100%" height=10></td></tr>
...
<table cellpadding="0" cellspacing="10" cellpadding="0" width="85%" align="center">
        <tr>
        <td class="bluetextbold" align="left">Browse Categories</td>
          </tr>
...
<table align="center">
  ...
  <tr>
        <td>
                <a href="index27.html">Home</a>
                <a href="aboutus.html">About Us</a>
                <a href="disclaimer.html">Disclaimer</a>
                <a href="terms.html">Terms Of Policy</a>
                </td>
        </tr>
                <tr>
