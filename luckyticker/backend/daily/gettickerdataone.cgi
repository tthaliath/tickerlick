...
my $charthtml .= "<tr><td><table><tr><td>Last price ".$tickerhash{PriceStat}." ".$tickerhash{pricediff}." from previous day close. Last price ".$tickerhash{difflowstat}." ".$tickerhash{perdifflow}."\% from 52 week low and ".$tickerhash{diffhighstat}." ".$tickerhash{perdiffhigh}."\% from 52 week high. 10 Day moving average is ".$tickerhash{dma10stat}." ".$tickerhash{dma10diff}." from last price\. 50 Day moving average is ".$tickerhash{dma50stat}." ".$tickerhash{dma50diff}." from last price\. 200 Day moving average is ".$tickerhash{dma200stat}." ".$tickerhash{dma200diff}." from last price\.</td></tr></table></td></tr>";
...
<table><tr><td>Last Trade&nbsp;:&nbsp$tickerhash{LastTrade}</td><td>Prev Close&nbsp;:&nbsp$tickerhash{PrevClose}</td><td>Volume&nbsp;:&nbsp$tickerhash{vol}</td></tr><tr><td>Nav&nbsp;:&nbsp$tickerhash{Nav}</td><td>52 Week Range&nbsp;:&nbsp$tickerhash{wkRange}</td><td>Yield&nbsp;:&nbsp$tickerhash{DivYield}</td>
</tr></table>
</td></tr></table>";
...
<tr><td>52 Week Range&nbsp;:&nbsp$tickerhash{wkRange}</td></tr>
 ...
 $resulthtml .= $charthtml;
$resulthtml .= "<table><tr><td>PE&nbsp;:&nbsp$tickerhash{PE}</td><td>Forward PE&nbsp;:&nbsp$tickerhash{ForwardPE}</td><td>EPS&nbsp;:&nbsp$tickerhash{EPS}</td></tr>
...
#if ($tickerhash{Ticker})
#{
#my $pricehistoryhtml = &getpricehistory($tickerhash{Ticker},50);
