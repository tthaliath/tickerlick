...
do
/usr/local/bin/python /home/tthaliath/tickerlick/history/rtq/python/get_yahoo_quote_final.py QCOM,SQ,TWTR,SPY,QQQ $NOW $PREVDATE
/usr/bin/perl /home/tthaliath/tickerlick/history/rtq/perlcalllist1.pl QCOM,SQ,TWTR,SPY,QQQ $NOW $PREVDATE
