...
do
/usr/local/bin/python /home/tthaliath/tickerlick/history/rtq/python/get_yahoo_quote_final.py BABA,BIDU,CMG,CRM,JPM $NOW $PREVDATE
/usr/bin/perl /home/tthaliath/tickerlick/history/rtq/perlcalllist1.pl BABA,BIDU,CMG,CRM,JPM $NOW $PREVDATE
