...
do
/usr/local/bin/python /home/tthaliath/tickerlick/history/rtq/python/get_yahoo_quote_final.py TSLA,FB,NFLX,AGN,GS $NOW $PREVDATE
/usr/bin/perl /home/tthaliath/tickerlick/history/rtq/perlcalllist1.pl TSLA,FB,NFLX,AGN,GS $NOW $PREVDATE
