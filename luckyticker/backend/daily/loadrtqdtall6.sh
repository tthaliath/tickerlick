...
do
/usr/local/bin/python /home/tthaliath/tickerlick/history/rtq/python/get_yahoo_quote_final.py MDB,MU,SNAP,SYMC,FIT $NOW $PREVDATE
/usr/bin/perl /home/tthaliath/tickerlick/history/rtq/perlcalllist1.pl MDB,MU,SNAP,SYMC,FIT $NOW $PREVDATE
