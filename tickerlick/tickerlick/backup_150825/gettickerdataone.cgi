...
<tr>
        <td>
               <button style="font-weight:bold;color:green" value="xos"  onclick="submitform2(r,\'xos\')" >Extremely Oversold</button>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=5></td>
        <td>    <button style="font-weight:bold;color:red" value="xob"  onclick="submitform2(r,\'xob\')" >Extremely Overbought</button>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=5></td></tr>
        </td>
...
elsif ($rep_type eq 'xob')
{
 ...
 while (@row = $sth->fetchrow_array)
 {
   ...
   {
      print "<tr><td>";
      print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[29]."</td><td>".$row[47]."</td><td>".$row[54]; 
     print "</td></tr>";
   }
   else
   {
