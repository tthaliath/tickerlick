...
$sql = "select price_date, ema_diff,ema_macd_9, (ema_diff - ema_macd_9) as signalstrength, ema_diff_5_35,ema_macd_5, (ema_diff_5_35 - ema_macd_5) as signalstrength2 from (select a.price_date, a.ema_diff,a.ema_macd_9, (a.ema_diff - a.ema_macd_9) as signalstrength, a.ema_diff_5_35,a.ema_macd_5, (a.ema_diff_5_35 - a.ema_macd_5) as signalstrength2 from tickerprice a where a.ticker_id = 1478 ORDER BY a.price_date DESC LIMIT 0,50) as abc order by price_date ASC";
...
print "Set-Cookie:Expires=Tuesday, 13-Nov-2012 23:12:40 GMT;\n";
print "Set-Cookie:Domain=www.tickerlick.com;\n";
