...
#print "$sql\n";
 ...
 #push (@bigarr,@macd);
 my $maxmin = "select max((dma_20 + (2 * dma_20_sd))) as max,min((dma_20 -  (2 * dma_20_sd))) as min from  (select a.dma_20,a.dma_20_sd from tickerprice a  where  ticker_id = ".$ticker_id." ORDER BY price_date DESC LIMIT 0,100) as abc";
