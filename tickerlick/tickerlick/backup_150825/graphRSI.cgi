...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select DATE_FORMAT(price_date, '%m/%d/%y') as price_date1, rsi_14, 30 as bottomline, 70 as topline from (select a.price_date, rsi_14  from tickerpricersi a where a.ticker_id = ".$ticker_id." ORDER BY a.price_date DESC LIMIT 0,100) as abc where rsi_14 is not null order by price_date ASC;";
 $sth = $dbh->prepare($sql);
