...
if ($tickerhash{Ticker})
{
  ...
  if ($signalhash{macd226})
   ...
   if ($signal eq "Buy")
   {
     ...
     $macdhtml = '<br>Current MACD (12,26,9) Indicator is <font color="#05840C" size="+2">bullish</font>. Last MACD crossover was on <strong>'.$signaldate.'</strong>.';
   }
   else
   {
     $macdhtml = '<br>Current MACD (12,26,9) Indicator is <font color="#FF0000" size="+2">Bearish</font>. Last MACD crossover was on <strong>'.signaldate.'</strong>.';
   }
 }
if ($signalhash{macd535})
   ...
   if ($signal eq "Buy")
   {
     ...
     $macdhtml = '<br>Current MACD (5,35,5) Indicator is <font color="#05840C" size="+2">bullish</font>. Last MACD crossover was on <strong>'.$signaldate.'</strong>.';
   }
   else
   {
     $macdhtml = '<br>Current MACD (5,35,5) Indicator is <font color="#FF0000" size="+2">Bearish</font>. Last MACD crossover was on <strong>'.signaldate.'</strong>.';
   }
}
