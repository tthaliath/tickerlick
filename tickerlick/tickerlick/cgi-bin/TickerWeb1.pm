...
print "test2\n";
$content =~ s/\n//g;
#$contet =~ s/(.*)?Headlines<\/a>.*?More\sHeadlines?(.*)/$1$2/gs;
#print "$content\n";
#exit 1;
...
if ($content =~ /(\>NAV\&|NAV\:|SPDR|Market Vectors|\sETN\s|Direxion|ProShare|EGShares|PowerShares|Global\sX|Sprott|PIMCO|Cambria|QuantShares|DBX\s|\sETF\s\($ticker\)|AlphaDEX|FactorShares|FlexShares)/)
{
 print "test4\n";
#print "$content\n";
#exit 1;
