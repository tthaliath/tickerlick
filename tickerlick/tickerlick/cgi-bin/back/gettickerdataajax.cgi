...
function submitform(obj ) {
    var l = obj
           ...
           l.q.value = s[0];
           document.f.action = "/cgi-bin/gettickerdataajax.cgi";
           document.f.submit();
           return true;
...
function submitform2(obj,reptype) {
           var r = obj
           r.s.value = reptype;
           document.r.action = "/cgi-bin/gettickerdataajax.cgi";
           document.r.submit();
           return true;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
   <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
       ...
       <form  name=f METHOD=GET action="/cgi-bin/gettickerdataajax.cgi">
      <table  align="center">
...
<form  name=r METHOD=GET action="/cgi-bin/gettickerdataajax.cgi">
...
elsif ($rep_type eq 'mbe')
{
 ...
 {
   print "<tr><td>";
   print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataajax.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[4];
   print "</td></tr>";
 }
 print "</table>";
 $sth->finish();
