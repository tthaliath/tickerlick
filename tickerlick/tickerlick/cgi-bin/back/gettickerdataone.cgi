...
<tr>
  ...
  <tr>
        <td>
                <a href="http://www.tickerlick.com/php2/report.php?r=rs">RSI Oversold (Bullish)</a>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=11></td>
        <td>    <a href="http://www.tickerlick.com/php2/report.php?r=rb">RSI Overbought (Bearish)</a>
        </td>
        </tr>
  ...
  <tr>
        <td>
                <a href="http://www.tickerlick.com/php2/report.php?r=ss">Stochastic Oversold (Bullish)</a>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=11></td>
        <td>    <a href="http://www.tickerlick.com/php2/report.php?r=sb">Stochastic Overbought (Bearish)</a>
        </td>
        </tr>
