...
<tr>
        <td>
                <a href="http://www.tickerlick.com/php2/report.php?r=mbu">MACD Bullish Crossover</a>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=11></td>
        <td>    <a href="http://www.tickerlick.com/php2/report.php?r=mbe">MACD Bearish Crossover</a>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
        </td>
...
<tr>
        <td>
                <a href="http://www.tickerlick.com/php2/report.php?r=mos">MACD Oversold (Bullish)</a>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=11></td>
        <td>    <a href="http://www.tickerlick.com/php2/report.php?r=mob">MACD Overbought (Bearish)</a>
        </td>
        </tr>
  ...
  <tr>
        <td>
                <a href="http://www.tickerlick.com/php2/report.php?r=ros">RSI/Stochastic Oversold (Bullish)</a>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=11></td>
        <td>    <a href="http://www.tickerlick.com/php2/report.php?r=rob">RSI/Stochastic Overbought (Bearish)</a>
        </td>
        </tr>
...
if ($signalhash{macd535})
  ...
  print "<tr><td><table align=\"center\"><tr><td><IMG SRC=\"/cgi-bin/drawchart.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
  #my $dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005') or die "Connection Error: $DBI::errstr\n";
  #my $tradechart = new TradeChart($ticker_id,$dbh);
  #$tradechart->drawcharts();
  print "$resulthtml\n";
