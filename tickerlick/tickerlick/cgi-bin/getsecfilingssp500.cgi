...
function submitForm2(obj ) {
	...
	if (l.value == "Search" )
	{
	   ...
	   document.f.action = "/cgi-bin/getsecfilingssp500.cgi";
	   document.f.submit();
	   return true;
	 }
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   ...
   <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
       ...
       <form  name=f METHOD=GET action="/cgi-bin/getsecfilingssp500.cgi">
...
{
    $sql ="select a.ticker,a.file_url, a.file_type, a.file_date, b.comp_name from sec_filing a, tickermaster b where a.ticker_id = b.ticker_id and a.file_date = '$ymd' order by a.ticker";
}
#print "$sql\n";
