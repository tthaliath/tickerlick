...
function submitform(obj ) {
    var l = obj
           ...
           l.q.value = s[0];
           document.f.action = "/cgi-bin/gettickerdataapi.cgi";
           document.f.submit();
           return true;
...
function submitform2(obj,reptype) {
           var r = obj
           r.s.value = reptype;
           document.r.action = "/cgi-bin/gettickerdataapi.cgi";
           document.r.submit();
           return true;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
   <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
       ...
       <form  name=f METHOD=GET action="/cgi-bin/gettickerdataapi.cgi">
      <table  align="center">
...
<form  name=r METHOD=GET action="/cgi-bin/gettickerdataapi.cgi">
...
elsif ($rep_type eq 'bbe')
{
 ...
 while (@row = $sth->fetchrow_array)
 {
   ...
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataapi.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3];
     print "</td></tr>";
   }
   elsif ($rep_type eq 'ef')
   {
      print "<tr><td>";
      print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataapi.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[29]."</td><td>".$row[47]."</td><td>".$row[54]; 
     print "</td></tr>";
   }
   else
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataapi.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[30]."</td><td>". $row[36];
    print "</td></tr>";
   }
 }
 print "</table>";
...
$result2html = "<tr><td><table><tr><td>Last Trade&nbsp;:&nbsp$tickerhash{lasttrade}</td><td>Prev Close&nbsp;:&nbsp$tickerhash{prevclose}</td><td>Volume&nbsp;:&nbsp$tickerhash{vol}</td><td>1 Year Target Est&nbsp;:&nbsp$tickerhash{oneyrtarget}</td></tr><tr><td>52 Week Range&nbsp;:&nbsp$tickerhash{wkRange}</td></tr></table></td></tr>";
#}
...
$resulthtml .= "<tr><td><table><tr><td>PE&nbsp;:&nbsp$tickerhash{pe}</td><td>Forward PE&nbsp;:&nbsp$tickerhash{forwardpe}</td><td>EPS&nbsp;:&nbsp$tickerhash{eps}</td></tr><tr><td>Market Cap&nbsp;:&nbsp$tickerhash{mktcap}</td><td>Beta&nbsp;:&nbsp$tickerhash{beta}</td></tr><tr><td>10 Day Moving Average&nbsp;:&nbsp$tickerhash{dma10}</td><td>50 Day Moving Average&nbsp;:&nbsp$tickerhash{dma50}</td><td>200 Day Moving Average&nbsp;:&nbsp$tickerhash{dma200}</td></tr>
</table>
...
if ($signalhash{macd535})
  ...
  print "<tr><td><table align=\"center\"><tr><td><IMG SRC=\"/cgi-bin/graphRSI.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphStoch.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
   print "<tr><td><table align=\"center\"><tr><td><IMG SRC=\"/cgi-bin/graphBOLLI.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
  print "$resulthtml\n";
