...
function submitform(obj ) {
    var l = obj
           ...
           l.q.value = s[0];
           document.f.action = "/cgi-bin/gettickerdataonertq.cgi";
           document.f.submit();
           return true;
...
function submitform2(obj,reptype) {
           var r = obj
           r.s.value = reptype;
           document.r.action = "/cgi-bin/gettickerdataonertq.cgi";
           document.r.submit();
           return true;
...
my $tophtml  .= '<table border="1" cellpadding="1" cellspacing="1" width="75%" align="center" style="border-collapse: collapse;">';
