...
my ($query);
 %tickhash = transformtickerdet1($str{'Ticker'},$str{'LastTradePriceOnly'},$str{'PreviousClose'},$str{'OneyrTargetPrice'},$str{'Volume'},$str{'YearLow'},$str{'YearHigh'},$str{'MarketCapitalization'},$str{'PERatio'},$str{'EarningsShare'});
return %tickhash;
}
