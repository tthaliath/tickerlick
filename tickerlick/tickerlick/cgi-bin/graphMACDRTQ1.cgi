...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select seq, 0 as centerline,rtq,dma_200,dma_10,dma_50 from (select a.rtq,a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq7 a where a.ticker_id =".$ticker_id." ORDER BY a.seq DESC LIMIT 0,200) as abc order by seq ASC";
 $sth = $dbh->prepare($sql);
