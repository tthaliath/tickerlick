...
my $dma10 = "";
my $maxticks = 390;
my ($hrs) = '9.30,10,11,12,1,2,3,4';
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 or die "Connection Error: $DBI::errstr\n";
 $sql = "select '', 0 as centerline,rtq,dma_200,dma_10,dma_50 from (select a.rtq,a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq7 a where a.ticker_id =".$ticker_id." and price_date = '2015-09-08' ORDER BY a.seq DESC LIMIT 0,390) as abc order by seq ASC";
#print "$sql\n";
 $sth = $dbh->prepare($sql);
