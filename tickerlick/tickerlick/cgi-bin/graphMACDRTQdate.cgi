...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select price_date, ema_diff_5_35,ema_macd_5, (ema_diff_5_35 - ema_macd_5) * 10 as signalstrength2, 0 as centerline,seq from (select a.rtq,a.ema_diff_5_35,a.ema_macd_5,(a.ema_diff_5_35 - a.ema_macd_5) as signalstrength2,a.price_date,a.seq from tickerrtq1 a where a.ticker_id =".$ticker_id." and price_date >= '2015-07-21' ORDER BY a.seq DESC) as abc where signalstrength2 is not null order by seq ASC";
 $sth = $dbh->prepare($sql);
