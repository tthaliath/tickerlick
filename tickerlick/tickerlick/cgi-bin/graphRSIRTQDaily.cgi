...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select rtq, rsi_14, 30 as bottomline, 70 as topline,'' from (select a.seq, rsi_14,rtq  from tickerrtq1 a where a.ticker_id = ".$ticker_id." and price_date = '2015-09-04' ORDER BY a.seq DESC LIMIT 0,200) as abc where rsi_14 is not null order by seq ASC";
 $sth = $dbh->prepare($sql);
