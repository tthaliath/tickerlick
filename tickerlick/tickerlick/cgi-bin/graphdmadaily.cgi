...
my $dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 my $sql = "select '',rtq,dma_200,dma_10,dma_50  from (select a.rtq,a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq7 a where a.ticker_id =".$ticker_id." and price_date = '$price_date' ORDER BY a.seq DESC) as abc order by seq ASC";
#print "$sql\n";
