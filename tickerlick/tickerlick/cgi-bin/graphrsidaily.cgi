...
my  $sql = "select  rsi_14, 30 as bottomline, 70 as topline,'' from (select rsi_14,seq  from tickerrtq7 a where a.ticker_id = ".$ticker_id." and price_date = '$price_date' ORDER BY a.seq DESC) as abc where rsi_14 is not null order by seq ASC";
#print "$sql\n";
