...
#$maxticks =150;
my (@row);
#if ($ticker_id == 10909){$maxticks = 390;}
my $dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 or die "Connection Error: $DBI::errstr\n";
 my $sql = "select '',close_price,sd20  from (select a.rtq,a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq7 a where a.ticker_id =".$ticker_id." and price_date = '$price_date' ORDER BY a.price_date DESC) as abc order by price_date ASC";
#print "$sql\n";
