...
function submitform(obj ) {
    var l = obj
           ...
           l.q.value = s[0];
           document.f.action = "/cgi-bin/gettickerdataone200.cgi";
           document.f.submit();
           return true;
...
function submitform2(obj,reptype) {
           var r = obj
           r.s.value = reptype;
           document.r.action = "/cgi-bin/gettickerdataone200.cgi";
           document.r.submit();
           return true;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
  ...
  <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
   <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
       ...
       <form  name=f METHOD=GET action="/cgi-bin/gettickerdataone200.cgi">
      <table  align="center" style="border-collapse: collapse;">
...
<form  name=r METHOD=GET action="/cgi-bin/gettickerdataone200.cgi">
...
<tr>
  ...
  <tr>
        <td>
                <button value="bbu" onclick="submitform2(r,\'bbu\')" >Bollinger Oversold (Bullish)</button>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=5></td>
        <td>    <button value="bbe" onclick="submitform2(r,\'bbe\')" >Bollinger Overbought (Bearish)</button>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=5></td></tr>
        </td>
  ...
  <tr>
        <td>
               <button value="mbux"  onclick="submitform2(r,\'mbux\')" >S&P 200 - MACD Bullish Crossover</button>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=5></td>
        <td> <button value="osx" onclick="submitform2(r,\'osx\')" >S&P 200 - MACD Oversold (Bullish)</button></td>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=5></td></tr>
        </td>
   ...
   <tr>
        <td>
                <button value="rsx" onclick="submitform2(r,\'rsx\')" >S&P 200 - RSI Oversold (Bullish)</button>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=5></td>
        <td>   <button value="ssx" onclick="submitform2(r,\'ssx\')" >S&P 200 - Stochastic Oversold (Bullish)</button> 
        </td>
        </tr>
   ...
   <tr>
        <td>
                <button value="bbux" onclick="submitform2(r,\'bbux\')" >S&P 200 - Bollinger Oversold (Bullish)</button>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=5></td></tr>
        </td>
...
{
    $title = "S&P200 - MACD (5,35,5) Oversold (Bullish)";
    $query = "SELECT a.ticker,a.comp_name,sector,industry FROM tickermaster a, report b where b.report_flag = 'OS' and b.ticker_id = a.ticker_id and a.tflag2 = 'Y' order by sector";
     }
...
{
     $title = "S&P200 - RSI Oversold (Bullish)";
     $query = "select ticker, comp_name,sector, industry from tickermaster a, report b where report_flag in ('RS') and a.ticker_id = b.ticker_id  and a.tflag2 = 'Y' order by sector";
}
...
{
     $title = "S&P200 - Stochastic Oversold (Bullish)";
     $query = "select ticker, comp_name,sector, industry from tickermaster a, report b where report_flag in ('SS') and a.ticker_id = b.ticker_id  and a.tflag2 = 'Y' order by sector";
}
...
{
     $title = "S&P200 - MACD Bullish Crossover";
     $query = "SELECT a.ticker,a.comp_name,sector,industry FROM tickermaster a, report b where b.report_flag = 'MBU' and b.ticker_id = a.ticker_id and a.tflag2 = 'Y' order by sector";
}
...
{
     $title = "S&P200 - Bollinger Bullish";
      $query = "SELECT a.ticker,a.comp_name,sector,industry FROM tickermaster a, report b where b.report_flag = 'BBU' and b.ticker_id = a.ticker_id  and a.tflag2 = 'Y' order by sector desc";
}
elsif ($rep_type eq 'bbe')
{
 ...
 while (@row = $sth->fetchrow_array)
 {
   ...
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone200.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3];
     print "</td></tr>";
   }
   elsif ($rep_type eq 'ef')
   {
      print "<tr><td>";
      print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone200.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[29]."</td><td>".$row[47]."</td><td>".$row[54]; 
     print "</td></tr>";
   }
   else
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone200.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[30]."</td><td>". $row[36];
    print "</td></tr>";
   }
 }
 print "</table>";
...
if ($tickerhash{Ticker})
{
 ...
 if ($signalhash{macd226})
   ...
   if ($signal eq "Buy")
   {
     ...
     $macdhtml .= '<br>Current MACD (12,26,9) trend is <font color="#05840C" size="+2">Bullish</font>. Last crossover was on <strong>'.$signaldate.'</strong>.';
   }
   else
   {
     $macdhtml .= '<br>Current MACD (12,26,9) trend is <font color="#FF0000" size="+2">Bearish</font>. Last crossover was on <strong>'.$signaldate.'</strong>.';
   }
 }
...
my $ratinghtml = &getratinghistory($ticker_id);   
  my $pricehistoryhtml = &getpricehistory($ticker_id,100); 
  $charthtml .= $rep_flag_html.$macdhtml."</td></tr></table></td></tr>";
  $resulthtml = $charthtml.$resulthtml;
  if ($tickerhash{tflag} eq 'Y')
 {
   print "<tr><td><table align=\"center\" style=\"border-collapse: collapse;\"><tr><td><IMG SRC=\"/cgi-bin/graphMACDRTQ1.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphMACDRTQ.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
   print "<tr><td><table align=\"center\" style=\"border-collapse: collapse;\"><tr><td><IMG SRC=\"/cgi-bin/graphRSIRTQ.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphBOLLIRTQ.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
}
  print "<tr><td><table align=\"center\" style=\"border-collapse: collapse;\"><tr><td><IMG SRC=\"/cgi-bin/graphMACD3.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphMACD4.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
  print "<tr><td><table align=\"center\" style=\"border-collapse: collapse;\"><tr><td><IMG SRC=\"/cgi-bin/graphRSI.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphStoch.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
