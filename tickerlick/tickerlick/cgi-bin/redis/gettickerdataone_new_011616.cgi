...
require "/home/tickerlick/cgi-bin/gettickerdetfull.pl";
...
function submitform(obj ) {
    var l = obj
           ...
           l.q.value = s[0];
           document.f.action = "/cgi-bin/gettickerdataone_new.cgi";
           document.f.submit();
           return true;
...
function submitform2(obj,reptype) {
           var r = obj
           r.s.value = reptype;
           document.r.action = "/cgi-bin/gettickerdataone_new.cgi";
           document.r.submit();
           return true;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
  ...
  <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
   <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=10></td></tr>
       ...
       <form  name=f METHOD=GET action="/cgi-bin/gettickerdataone_new.cgi">
      <table  align="center" style="border-collapse: collapse;">
...
<form  name=r METHOD=GET action="/cgi-bin/gettickerdataone_new.cgi">
<input type="hidden" name="s">
<table align="center" style="border-collapse: collapse;">
<tr>
        <td>
               <button style="font-weight:bold;color:green" value="xos"  onclick="submitform2(r,\'xos\')" >Oversold</button>
        </td>
        <td><img src="http://tickerlick.com/images/spacer.gif" width = "5" height=5></td>
        <td>    <button style="font-weight:bold;color:red" value="xob"  onclick="submitform2(r,\'xob\')" >Overbought</button>
        </td>
        </tr>
        <tr><td><img src="http://tickerlick.com/images/spacer.gif" width = "100%" height=5></td></tr>
        </td>
...
elsif ($rep_type eq 'xob')
{
 ...
 while (@row = $sth->fetchrow_array)
 {
   ...
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone_new.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3];
     print "</td></tr>";
   }
   elsif ($rep_type eq 'ef')
   {
      print "<tr><td>";
      print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone_new.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[29]."</td><td>".$row[47]."</td><td>".$row[54]; 
     print "</td></tr>";
   }
   else
   {
     print "<tr><td>";
     print "<a href=http://www.tickerlick.com/cgi-bin/gettickerdataone_new.cgi?q=".$row[0].">".$row[0]."</a></td><td>" . $row[1] ."</td><td>". $row[2] ."</td><td>". $row[3]."</td><td>". $row[4]."</td><td>". $row[5]."</td><td>". $row[6]."</td><td>". $row[7]."</td><td>". $row[8]."</td><td>". $row[9]."</td><td>". $row[10]."</td><td>". $row[11]."</td><td>". $row[12]."</td><td>". $row[13]."</td><td>". $row[30]."</td><td>". $row[36];
    print "</td></tr>";
   }
 }
 print "</table>";
