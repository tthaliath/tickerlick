...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select seq, 0 as centerline,rtq,dma_200,dma_10,dma_50,'' from (select round(a.rtq,1) 'rtq',a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq a where a.ticker_id =".$ticker_id." and price_date = '2015-09-02' ORDER BY a.seq ASC LIMIT 0,390) as abc order by seq ASC";
 $sth = $dbh->prepare($sql);
