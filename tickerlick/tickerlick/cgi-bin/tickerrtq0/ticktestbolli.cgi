...
$sql = "select '',rtq,dma_20, (dma_20 + (2 * dma_20_sd)) as dma_20_top,(dma_20 -  (2 * dma_20_sd)) as dma_20_bottom from (select a.seq,a.rtq,a.dma_20,a.dma_20_sd from tickerrtq a  where  ticker_id = ".$ticker_id." and price_date = '2015-09-08' ORDER BY seq DESC LIMIT 0,200) as abc order by seq ASC";
#print "$sql\n";
