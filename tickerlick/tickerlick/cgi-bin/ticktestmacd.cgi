...
my $sql = "select '', ema_diff_5_35,ema_macd_5, (ema_diff_5_35 - ema_macd_5) * 10 as signalstrength2, 0 as centerline,rtq from (select a.rtq,a.ema_diff_5_35,a.ema_macd_5,(a.ema_diff_5_35 - a.ema_macd_5) as signalstrength2,a.seq from tickerrtq1 a where a.ticker_id =".$ticker_id." and price_date = '2015-09-10' ORDER BY a.seq DESC LIMIT 0,390) as abc where signalstrength2 is not null order by seq ASC";
#print "$sql\n";
