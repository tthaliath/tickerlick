...
$dbh = DBI->connect('dbi:mysql:tickmaster','root','Neha*2005')
 ...
 $sql = "select '',192 as centerline,rtq,dma_200,dma_10,dma_50,193 as topline  from (select a.rtq,a.seq,a.dma_200,a.dma_50,a.dma_10 from tickerrtq1 a where a.ticker_id =".$ticker_id." and price_date = '2015-09-04' ORDER BY a.seq DESC LIMIT 0,200) as abc order by seq ASC";
#print "$sql\n";
 $sth = $dbh->prepare($sql);
