...
#print "<tr><td><table align=\"center\" style=\"border-collapse: collapse;\"><tr><td><IMG SRC=\"/cgi-bin/graphStoch.cgi?tickid=$ticker_id\"></td><td><IMG SRC=\"/cgi-bin/graphBOLLI.cgi?tickid=$ticker_id\"></td></tr></table></td></tr>";
  print "$resulthtml\n";
  print "$ratinghtml\n";
