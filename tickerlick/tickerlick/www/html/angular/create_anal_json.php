...
$result = $conn->query("select b.ticker,brokerage_name,rating_date,updown,rating_from,rating_to,price_from,price_to from rating_master a, tickermaster b  where a.ticker_id = b.ticker_id and b.price_flag = 'Y'");
$results = array();
