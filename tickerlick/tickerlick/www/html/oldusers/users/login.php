...
if(isset($_POST['submitted']))
{
   if($fgmembersite->Login())
   {
        if (isset($_POST['ma']))
        {
           $fgmembersite->RedirectToURL("ma.php");
        }
        else
        {
...
<div class='long_explanation'><a href='reset-pwd-req.php'>Forgot Password?</a></div><br>
<div class='long_explanation'>Not a member yet? <a href="register.php">Register</a></div>
</fieldset>
<table align="center">
