...
{
    $ustat = 0;
    $fgmembersite->RedirectToURL("http://www.luckyticker.com/users/login.php?p=ma");
    exit;
}
else
{
...
<head>
      ...
      <link rel="STYLESHEET" type="text/css" href="http://luckyticker.com/users/style/checkbox.css" />
...
<div id='subupdate' align="center"><h2><?php if(isset($_POST['formSubmit'])){ echo "The subscription has been successfully updated"; } ?></h2></div>
<!-- Form Code Start -->
